...
Current state, all green: **13 suites, 127 cases, 533 checks** — 101 cases / 458 checks in the browser
(bearing 13, filters 10, geometry 15, infopanel 10, labels 9, lifts 8, lists 13, regions 13, solo 10) and
