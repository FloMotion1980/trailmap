...
Current state, all green: **13 suites, 128 cases, 537 checks** — 102 cases / 462 checks in the browser
(bearing 14, filters 10, geometry 15, infopanel 10, labels 9, lifts 8, lists 13, regions 13, solo 10) and
